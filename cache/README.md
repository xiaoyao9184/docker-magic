...
such as the `PDF-Extract-Kit-1.0` model below.

The folder structure for `./cache/huggingface/hub/models--opendatalab--PDF-Extract-Kit-1.0` is as follows.
...
It will use `./cache/huggingface/hub/models--opendatalab--PDF-Extract-Kit-1.0/snapshots/ce49c1fe10842e78b8be61f9e762b85ac952807d`.
...
```bash
huggingface-cli download --repo-type model --revision main --cache-dir ./cache/huggingface/hub opendatalab/PDF-Extract-Kit-1.0
huggingface-cli download --repo-type model --revision main --cache-dir ./cache/huggingface/hub hantian/layoutreader
huggingface-cli download --repo-type model --revision main --cache-dir ./cache/huggingface/hub --include paddleocr/ --repo-type space opendatalab/MinerU
```